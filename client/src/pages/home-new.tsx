...
import { Bell, Settings, Search, Home, MessageCircle, ShoppingBag, Calendar, User as UserIcon } from "lucide-react";
...
export default function Home() {
  ...
  const handleServiceClick = (category: string) => {
    // Navegar para página de busca com categoria específica
